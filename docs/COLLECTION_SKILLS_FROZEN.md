...
- **成果**：2019-2026 扫描 926 篇，体育新闻/传播相关文献**实际入库 143 篇**（标题+摘要关键词筛选，覆盖 38 期）。
- **数据源限制**：2019-2023（及部分2024）老结构详情页**不含作者姓名行**（作者仅存在于 PDF 全文），该批文章 author 留空；2025+ 新结构作者解析完整。
...
- ✅ **L2 体育学刊官网（2026-08-17 新增）**：已采集入库 143 篇体育新闻/传播相关文献（2019-2026，覆盖 38 期，`data_source='tykx_scnu_official'`）。
- ✅ **L3 主题弱项**：已采集并清理 550 篇国际文献（性别144/电竞137/国际传播107/技术89/伦理73），较采集前提升 20-50 倍。
- ✅ **权威库三处同步**：总文献 **12249 篇**（国内10397/国际1852），FTS 索引与主表完全同步。
