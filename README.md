...
| 维度 | 数据 |
|------|------|
| **总文献数** | 12106 篇（经多源增量抓取 + NCPSSD 白名单 + 官网 + 主题弱项补强） |
| **国内文献** | 10254 篇（NCPSSD + 体育科学官网为主源） |
| **国际文献** | 1852 篇（含 Crossref / OpenAlex 抓取） |
| **核心学者** | 12 位（scholars表） |
| **涵盖语种** | 7 种（中/英/德/法/日/西/韩） |
| **研究分类** | 15 个一级分类（分类规则见 `config/parameters.json`） |
| **摘要覆盖** | 95.5%（11561/12106 有摘要） |
| **翻译覆盖** | 中文摘要 2420 篇（占国际文献中需译部分；百度免费额度 2026-08 已用尽，9 月重置后续译） |
| **关键词覆盖** | 22.7%（2743/12106） |
